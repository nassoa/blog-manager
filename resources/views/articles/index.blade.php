...
@if ($articles->count() > 0)
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border transition-shadow">
            <div class="p-6 flex flex-col justify-between h-full gap-y-10">
                <div class="space-y-2">
                    ...
                    <p class="text-slate-700 mb-4 break-words">{{ Str::limit($article->content, 100) }}</p>
                </div>
